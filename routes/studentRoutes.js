...
const { GetStudents, EditStudents, GetMyClassStudents, GetStudentAttendanceForTeacher, GetStudentReceiptForTeacher, DeleteStudent } = require('../controllers/StudentController');
...
router.delete('/:id', verifyToken, checkRole(['SUPER_ADMIN', 'ADMIN']), DeleteStudent);
